...
@section('content')
    ...
    <div class='movie-info border-b border-gray-800'>
        <div class='container mx-auto px-16 py-16 flex flex-col md:flex-row'>
            <div class='flex-none'>
                <img src="{{ $actor['profile_path'] }}" alt="Actor Profile Image" class='w-76'>
            ...
            <div class='md:ml-24'>
                ...
                <div class="flex flex-wrap items-center text-gray-400 pt-1 text-sm">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                @foreach ($credits as $credit)
                    <li>
                        ...
                        <strong><a href="{{ route('actors.show', $credit['id']) }}" class="hover:underline">{{ $credit['title'] }}</a></strong>
                         as {{ $credit['character'] }}
                     </li>
                @endforeach
