...
@section('content')
    ...
    <div class='movie-cast border-b border-gray-800'>
        ...
        <div class='container mx-auto px-16 py-16'>
            ...
            <h2 class='text-4xl font-sermibold'>Cast</h2>
                ...
                @foreach($movie['cast'] as $cast)
                    <div class="mt-8">
                        <a href="{{ route('actors.show', $cast['id']) }}">
                            <img src="https://image.tmdb.org/t/p/w500/{{ $cast['profile_path'] }}" alt="{{ $movie['title'] }}" class='hover:opacity-75 transition ease-in-out duration-150'>
                        </a>
